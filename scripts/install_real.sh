...
BOT_TRADING_SYMBOLS=DOGEUSDT,XRPUSDT,ADAUSDT,TRXUSDT,SOLUSDT,MATICUSDT,LINKUSDT,AVAXUSDT,DOTUSDT,LTCUSDT,ATOMUSDT,NEARUSDT,ARBUSDT,OPUSDT,APTUSDT,SUIUSDT,INJUSDT,SEIUSDT,PEPEUSDT,WIFUSDT,BONKUSDT,FLOKIUSDT,SHIBUSDT,FILUSDT,ETCUSDT,AAVEUSDT,UNIUSDT,RUNEUSDT,ALGOUSDT,HBARUSDT
BOT_MARGIN_STRESS=0.60
BOT_MARGIN_RECOVERY=0.30
BOT_MIN_NOTIONAL=1.0
BOT_POLL_SECONDS=5
BOT_DRY_RUN=false
